@GW_PC_TC001
Feature: GW_PC_TC001_New Business_Retrieve MVR option_Driver Screen 
    Background:
        Given User is on login page


    @Smoke @GW_PC_TC001 @Regression
    Scenario Outline: To view the Retrieve MVR option in Driver Screen after adding the driver details
        ...
        And User should view the Retrieve MVR option in Driver Screen after adding the driver details
