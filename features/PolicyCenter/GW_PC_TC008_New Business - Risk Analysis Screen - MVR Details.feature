@GW_PC_TC008
Feature: GW_PC_TC008_New Business_Risk Analysis Screen
    Background:
        Given User is on login page

    @GW_PC_TC008 @Regression @Smoke
    Scenario Outline: To verify that user is able to view the details and status of the MVR tab in Risk Analysis Page
