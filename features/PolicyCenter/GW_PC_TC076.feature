@GW_PC_TC076
Feature: GW_PC_TC076_changing_Underinsured_motorist_dropdown_value
  Background:
  ...
  Scenario Outline: To verify the Auto generated data about Motor Vehicle Record in Vehicle Screen
    ...
    And User updates the values present in PA-coverages screen "<UMPD>"
    ...
    Examples:
     | firstname   | lastname   | AccountNumber | Offering Selection | Date of Birth | License No. | License State | Year First Licensed | VIN               | VLicense State | CostNew | UMPD     |
     | Transformers| Autobots   | 2483984603    | Basic Program      | 02/07/1995    | A98765432   | Arizona       | 2015                | 2FMDK51C99BA83243 | Arizona        | 2000    | $50,000  |
