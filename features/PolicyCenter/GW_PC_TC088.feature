@GW_PC_TC088
Feature: GW_PC_TC088_user_is_able_to_select_1000_as_deductible
  Background:
  ...
  Scenario Outline: To verify the Auto generated data about Motor Vehicle Record in Vehicle Screen
    ...
    And User verifies checkbox and is able to click on it
    And User is able to view Collision deductible
    And User is able to select "<deductible>" from the dropdown
    ...
    Examples:
     | firstname   | lastname   | AccountNumber | Offering Selection | Date of Birth | License No. | License State | Year First Licensed | VIN               | VLicense State | CostNew | deductible|
     | Transformers| Autobots   | 2483984603    | Basic Program      | 02/07/1995    | A98765432   | Arizona       | 2015                | 2FMDK51C99BA83243 | Arizona        | 2000    | 1,000      |
