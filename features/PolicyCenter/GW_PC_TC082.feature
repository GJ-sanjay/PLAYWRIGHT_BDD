@GW_PC_TC082
Feature: GW_PC_TC082_user_is_able_to_select_no_deductible_option
  Background:
  ...
  Scenario Outline: To verify the Auto generated data about Motor Vehicle Record in Vehicle Screen
    ...
    And User is able to select No deductible from the dropdown
    ...
    Examples:
     ...
     | Transformers| Autobots   | 2483984603    | Basic Program      | 02/07/1995    | A98765432   | Arizona       | 2015                | 2FMDK51C99BA83243 | Arizona        | 2000    | 
