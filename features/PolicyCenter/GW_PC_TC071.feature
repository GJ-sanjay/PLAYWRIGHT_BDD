@GW_PC_TC071
Feature: GW_PC_TC071_changing_dropdown_values
  Background:
    Given User is on login page   

  @GW_PC_TC071 @Regression @Sanity
  Scenario Outline: To verify the Auto generated data about Motor Vehicle Record in Vehicle Screen
    ...
    And User Validates the values present in PA-coverages screen 
    And User updates the values present in PA-coverages screen "<ALO>" "<MLO>" "<UMO>"
    ...
    Examples:
     | firstname   | lastname   | AccountNumber | Offering Selection | Date of Birth | License No. | License State | Year First Licensed | VIN               | VLicense State | CostNew | ALO     | MLO   | UMO    |
     | Transformers| Autobots   | 2483984603    | Basic Program      | 02/07/1995    | A98765432   | Arizona       | 2015                | 2FMDK51C99BA83243 | Arizona        | 2000    | 25/50/25| 25,000 | 25/50  |
