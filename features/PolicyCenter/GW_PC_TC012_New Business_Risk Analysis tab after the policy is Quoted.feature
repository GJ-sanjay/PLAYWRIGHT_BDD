@GW_PC_TC012
Feature: GW_PC_TC012_New Business - Risk Analysis tab after the policy is Quoted
    Background:
        Given User is on login page

    @GW_PC_TC012 @Regression @Smoke
    Scenario Outline: To verify that user is view the MVR details in Risk Analysis tab after the policy is Quoted
        ...
        And User should view the MVR details in Risk Analysis tab after the policy is Quoted
