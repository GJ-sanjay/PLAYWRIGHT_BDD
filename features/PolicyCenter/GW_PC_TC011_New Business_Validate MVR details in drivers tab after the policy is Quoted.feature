@GW_PC_TC011
Feature: GW_PC_TC011_New Business_Validate MVR details in drivers tab after the policy is Quoted
    Background:
        Given User is on login page

    @GW_PC_TC011 @Regression @Smoke
    Scenario Outline: To verify that user is view the MVR details in drivers tab after the policy is Quoted
        ...
        And User again Navigate to Drivers tab in Quote Page and Check the details in Motor Vehicle Record tab 
