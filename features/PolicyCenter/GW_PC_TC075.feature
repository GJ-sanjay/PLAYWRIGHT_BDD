@GW_PC_TC075
Feature: GW_PC_TC075_validate_whether_property_damage_is_visible
  Background:
    Given User is on login page   

  @Sanity @Regression @GW_PC_TC075
  Scenario Outline: To verify the Auto generated data about Motor Vehicle Record in Vehicle Screen
    ...
    And User should be able to select UnderInsured Motorist-property damage Limit and view it.
