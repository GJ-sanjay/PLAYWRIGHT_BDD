@GW_PC_TC007
Feature: GW_PC_TC007_New Business_Validate MVR details screen
    Background:
        Given User is on login page

    @GW_PC_TC007 @Regression @Smoke
    Scenario Outline: To verify that user is able to view the report date ,requested date ,Years Requested, driver tab , Incident tab and Additional info tab in Motor Vehicle Record Screen
        ...
        Then User should able to navigated the Motor Vehicle Record Screen and able to view report date ,requested date ,Years Requested, driver tab , Incident tab and Additional info tab in Motor Vehicle Record Screen
