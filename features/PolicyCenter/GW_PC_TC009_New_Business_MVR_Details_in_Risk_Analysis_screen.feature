@GW_PC_TC009
Feature: GW_PC_TC009_New_Business_MVR_Details_in_Risk_Analysis_screen
    Background:
        Given User is on login page
        And User enter username and password
        And User verify LoginTitle

    @GW_PC_TC009 @Regression @Smoke
    Scenario Outline: To verify the user is able to validate the MVR details from Risk analysis screen
