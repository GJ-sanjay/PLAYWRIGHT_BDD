@GW_PC_TC014
Feature: GW_PC_TC014_New Business - Risk Analysis tab after the policy is Issued
    Background:
        Given User is on login page

    @GW_PC_TC014 @Regression @Smoke
    Scenario Outline: To verify that user is able to view the MVR details in the Risk Analysis tab after the policy is issued
        ...
        And User should view the MVR details in Risk Analysis tab after the policy is Issued
