@GW_PC_TC078
Feature: GW_PC_TC078_quoting_policy_after_unselecting_underinsured_motorist_vehicle_damage
  Background:
  ...
  Scenario Outline: To verify the Auto generated data about Motor Vehicle Record in Vehicle Screen
    ...
    And check whether user is able to quote policy after unselecting underinsured_motorist
