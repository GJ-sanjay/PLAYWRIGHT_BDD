@GW_PC_TC003
Feature: GW_PC_TC003_New Business_Adding more than one drivers in the drivers screen
    Background:
        Given User is on login page
        And User enter username and password
        And User verify LoginTitle

    @Smoke @GW_PC_TC003 @Regression
    Scenario Outline: To verify that user is able to Retrieve MVR for more than one drivers in the drivers Tab
        ...
        And User should be able to view the Retrieve MVR option in Driver Screen after adding the more than one drivers
        ...
        And User enter the New Driver deatils in Drivers Page "<Year First Licensed>"
