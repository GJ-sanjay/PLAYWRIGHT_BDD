@GW_PC_TC004 
Feature: GW_PC_TC004_New Business_Validate Driver details b/w MVR details
    Background:
    ...
    @GW_PC_TC004 @Regression @Smoke
    Scenario Outline: To verify that user is able to view the listed fields in Motor Vehicle Records tab and should be match with the driver details
        ...
        And user should view the listed fields in Motor Vehicle Records tab and should be match with the driver details "<Date of Birth>" "<License No.>" "<License State>"
