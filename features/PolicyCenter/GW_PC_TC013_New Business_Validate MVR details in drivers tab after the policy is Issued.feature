@GW_PC_TC013
Feature: GW_PC_TC013_New Business_Validate MVR details in drivers tab after the policy is Issued
    Background:
        Given User is on login page

    @GW_PC_TC013 @Regression @Smoke
    Scenario Outline: To verify that user is view the MVR details in drivers tab after the policy is issued
        ...
        And User again Navigate to Drivers tab and Check the details in Motor Vehicle Record tab 
